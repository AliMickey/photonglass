...
[![](screenshot.png)](https://raw.githubusercontent.com/AliMickey/photonglass/refs/heads/main/screenshot.png)
...
- **Shareable Links**: Prefill the form from the URL, e.g. `/?device=sydney1&command=ping&target=1.1.1.1`, where `device=all` selects every device.
